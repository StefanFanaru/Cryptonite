...
namespace Cryptonite.Infrastructure.Data.DataMigrations
{
    ...
    {
        private readonly CryptoniteContext _context;
        private readonly IEnumerable<IDataMigration> _dataMigrations;

        public DataMigrator(CryptoniteContext context, IEnumerable<IDataMigration> dataMigrations)
        {
            _context = context;
        ...
        public void MigrateData()
        {
            ...
            {
                migration.Migrate();
                InsertDatabaseMigration(migration.GetType().Name, nameof(CryptoniteContext));
